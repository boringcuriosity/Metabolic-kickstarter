...
import svgPaths from "./svg-bk7kig61qo";
  ...
  return (
    <div className="absolute left-1/2 size-[16px] top-1/2 translate-x-[-50%] translate-y-[-50%]" data-name="tracker icons">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="tracker icons">
          <path d={svgPaths.p3d251780} fill="url(#paint0_linear_3_1107)" id="Vector" />
        </g>
        <defs>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_3_1107" x1="3.41642" x2="13.7482" y1="1.98208" y2="13.0363">
...
function GoalOfTheDay() {
  return (
    <div className="content-stretch flex items-center gap-[8px] relative shrink-0 w-full" data-name="goal of the day">
      <IconForGoal />
      <div className="font-['Roboto:SemiBold',_sans-serif] font-semibold leading-[0] relative flex-1 text-[18px] text-white tracking-[0.25px] pr-4" style={{ fontVariationSettings: "'wdth' 100" }}>
        <p className="leading-[24px]">Drink 2 glasses of water when you wake up</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="bg-[#6172f3] box-border content-stretch flex gap-[4px] items-center justify-center px-[8px] py-[4px] relative rounded-[24px] shrink-0" data-name="coupon">
      <div className="font-['Roboto:Regular',_sans-serif] font-normal leading-[0] relative shrink-0 text-[14px] text-nowrap text-white tracking-[0.25px]" style={{ fontVariationSettings: "'wdth' 100" }}>
        <p className="leading-[1.2] whitespace-pre">+ Add fibres to meals</p>
      </div>
    </div>
  );
}
...
function ReinforceHabits() {
  return (
    <div className="content-stretch flex flex-wrap gap-[10px] items-center justify-start relative shrink-0 w-full" data-name="reinforce habits">
      <Coupon />
    </div>
  );
}
...
function MainGoal() {
  return (
    <div className="box-border content-stretch flex flex-col gap-[12px] items-start justify-start p-[16px] relative shrink-0 w-full bg-gradient-to-br from-[#444CE7] to-[#2D3282]" data-name="main goal">
      <GoalOfTheDay />
      <OptionalSeparator />
      <ReinforceHabits />
    </div>
...
export default function GoalDay2Week2() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start justify-start relative size-full" data-name="goal day 2">
      <Heading />
      <MainGoal />
    </div>
  );
