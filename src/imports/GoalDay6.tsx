import svgPaths from "./svg-fqtn4w5srp";
  ...
  return (
    <div className="content-stretch flex items-start gap-[8px] relative shrink-0 w-full" data-name="goal of the day">
      ...
      <div className="font-['Roboto:SemiBold',_sans-serif] font-semibold leading-[0] relative shrink-0 text-[18px] text-white tracking-[0.25px] flex-1" style={{ fontVariationSettings: "'wdth' 100" }}>
        <p className="leading-[24px]">Have a Light Meal Day</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="relative shrink-0 w-full" data-name="main goal">
      <div className="relative size-full">
        <div className="box-border content-stretch flex flex-col gap-[4px] items-start justify-start p-[16px] relative w-full bg-gradient-to-br from-[#444CE7] to-[#2D3282]">
          <GoalOfTheDay />
        </div>
      </div>
    </div>
...
export default function GoalDay6() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start justify-start relative size-full" data-name="goal day 6">
      <Heading />
      <MainGoal />
    </div>
  );
