...
import imgChatGptImageAug192025082447Am from "figma:asset/149006d9359e03e33dd71ab43dd5e67a3c50b387.png";
import imgChatGptImageAug192025082652Am from "figma:asset/69a2936e1b3bfc4774e606c2cdced116f2954b61.png";

function InfoIcon() {
  return (
    <div className="bg-[#fef1c7] overflow-clip relative rounded-[100px] shrink-0 size-[60px]" data-name="info icon">
      <div className="absolute bg-center bg-cover bg-no-repeat left-0 size-[60px] top-0" data-name="ChatGPT Image Aug 19, 2025, 08_24_47 AM" style={{ backgroundImage: `url('${imgChatGptImageAug192025082447Am}')` }} />
    </div>
  );
}
...
function InfoIcon1() {
  return (
    <div className="bg-[#fef1c7] overflow-clip relative rounded-[100px] shrink-0 size-[60px]" data-name="info icon">
      <div className="absolute bg-center bg-cover bg-no-repeat left-0 size-[60px] top-0" data-name="ChatGPT Image Aug 19, 2025, 08_26_52 AM" style={{ backgroundImage: `url('${imgChatGptImageAug192025082652Am}')` }} />
    </div>
  );
}
...
function InfoCard1() {
  return (
    <div className="basis-0 bg-[#fffbee] grow min-h-px min-w-px relative rounded-[16px] shrink-0" data-name="info card">
      <div className="flex flex-col items-center overflow-clip relative size-full">
        <div className="box-border content-stretch flex flex-col gap-[16px] items-center justify-start p-[16px] relative w-full">
          <InfoIcon1 />
          <div className="font-['Roboto:Regular',_sans-serif] font-normal leading-[0] min-w-full relative shrink-0 text-[#101828] text-[14px] text-center tracking-[0.25px]" style={{ width: "min-content", fontVariationSettings: "'wdth' 100" }}>
