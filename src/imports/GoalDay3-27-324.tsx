...
function GoalOfTheDay() {
  return (
    <div className="content-stretch flex items-start justify-between relative shrink-0 w-[358px]" data-name="goal of the day">
      <IconForGoal />
...
function MainGoal() {
  return (
    <div className="box-border content-stretch flex flex-col gap-[12px] items-start justify-start p-[16px] relative shrink-0 w-[390px] bg-[rgba(45,50,130,1)]" data-name="main goal">
      <GoalOfTheDay />
      <OptionalSeparator />
      <ReinforceHabits />
    </div>
