import svgPaths from "./svg-i7j0rhxaip";
...
function GoalOfTheDay() {
  return (
    <div className="content-stretch flex items-center justify-between relative shrink-0 w-[358px]" data-name="goal of the day">
      <IconForGoal />
      <div className="font-['Roboto:SemiBold',_sans-serif] font-semibold leading-[0] relative shrink-0 text-[18px] text-white tracking-[0.25px] w-[326px]" style={{ fontVariationSettings: "'wdth' 100" }}>
...
function ReinforceHabits() {
  return (
    <div className="content-stretch flex gap-[10px] items-center justify-start relative shrink-0 w-full" data-name="reinforce habits">
      <Coupon />
    </div>
  );
}
...
function MainGoal() {
  return (
    <div className="box-border content-stretch flex flex-col gap-[12px] items-start justify-start p-[16px] relative shrink-0 w-[390px]" data-name="main goal">
      <GoalOfTheDay />
      <OptionalSeparator />
      <ReinforceHabits />
    </div>
...
export default function GoalDay2() {
  return (
