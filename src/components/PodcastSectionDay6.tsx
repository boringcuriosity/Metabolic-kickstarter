import imgFrame8 from "../assets/day_6_cover.png";
...
export default function PodcastSectionDay6() {
  return (
    <div className="content-stretch flex flex-col gap-[10px] items-start justify-start relative size-full" data-name="podcast section">
      ...
      <Player 
        englishUrl={PODCAST_AUDIO_URLS.week1.day6.english}
        hindiUrl={PODCAST_AUDIO_URLS.week1.day6.hindi}
      />
    </div>
  );
}