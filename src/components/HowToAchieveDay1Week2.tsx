...
interface HowToAchieveDay1Week2Props {
  onItemComplete?: (itemId: string) => void;
}

export function HowToAchieveDay1Week2({ onItemComplete }: HowToAchieveDay1Week2Props) {
  const actionItems: ActionItem[] = [
    {
      id: "continue-protein",
      title: "Continue your protein habit from Week 1",
      description: "",
      subItems: [
        {
          category: "",
          items: "Keep adding paneer, tofu, eggs, chicken, or fish to your meals. Protein remains your base."
        }
      ]
    },
    {
      id: "pair-fibre",
      title: "Pair your protein with one extra serving of fibre-rich foods",
      description: "",
      subItems: [
        {
          category: "",
    ...
    },
    {
      ...
      subItems: [
        {
          category: "",
          items: "Boiled eggs + cucumber, paneer cubes + carrot sticks, almonds, pistachios, chia seeds, and flaxseeds, guava, banana, peas"
        }
      ]
    }
  ];
