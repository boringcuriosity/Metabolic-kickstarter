...
export function ResourceCard({ image, title, type, onClick }: ResourceCardProps) {
  return (
    <div 
      className="bg-gradient-to-r from-[#fffbee] relative rounded-[16px] shrink-0 to-[#fff8e0] w-full cursor-pointer"
      onClick={onClick}
    >
      <div className="relative size-full">
        <div className="box-border content-stretch flex gap-[12px] items-start justify-start px-[16px] py-[12px] relative w-full">
          <div className="overflow-clip relative rounded-[12px] shrink-0 size-[54px]">
            <div 
              className="absolute bg-center bg-cover bg-no-repeat h-[54px] left-0 top-0 w-[82px]"
          ...
          <div className="basis-0 content-stretch flex flex-col gap-[8px] grow items-start justify-start min-h-px min-w-px relative shrink-0">
            <div className="content-stretch flex items-center justify-between relative shrink-0 w-full">
              <div className="bg-[#cda935] box-border content-stretch flex gap-[10px] items-center justify-center px-[8px] py-[4px] relative rounded-[24px] shrink-0">
