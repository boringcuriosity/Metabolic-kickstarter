import imgFrame3 from "../assets/day_2_cover.png";
...
export default function PodcastSectionDay2() {
  return (
    <div className="content-stretch flex flex-col gap-[10px] items-start justify-start relative size-full" data-name="podcast section">
      ...
      <Player 
        englishUrl={PODCAST_AUDIO_URLS.week1.day2.english}
        hindiUrl={PODCAST_AUDIO_URLS.week1.day2.hindi}
      />
    </div>
  );
}