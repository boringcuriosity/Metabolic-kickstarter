...
interface HowToAchieveDay7Week2Props {
...
export function HowToAchieveDay7Week2({ onItemComplete }: HowToAchieveDay7Week2Props) {
  const actionItems: ActionItem[] = [
    {
      id: "choose-favourite-food",
      title: "Choose your favourite food",
      description: "",
      subItems: [
        {
          category: "",
          items: "Whether it's pizza, dessert, or street food you've been craving, enjoy it fully and truly."
        }
      ]
    },
    {
      ...
      subItems: [
        {
          category: "",
          items: "Take a moment to notice the changes you've made in the past 4 weeks: more protein, better hydration, regular movement, improved sleep"
        }
      ]
    },
    {
      ...
      subItems: [
        {
          category: "",
          items: "One treat won't undo your progress. What matters is that tomorrow, you return to the habits you've built"
        }
      ]
    }
  ];
