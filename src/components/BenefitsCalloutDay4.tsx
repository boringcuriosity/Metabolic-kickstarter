function InfoIcon() {
  return (
    <div className="bg-[#fef1c7] overflow-clip relative rounded-[100px] shrink-0 size-[60px]" data-name="info icon">
      <div className="absolute bg-center bg-cover bg-no-repeat left-0 size-[60px] top-0" data-name="sleep icon" style={{ backgroundImage: `url('https://images.unsplash.com/photo-1745562294709-d895f1d04254?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxzbGVlcCUyMHJlc3QlMjByZWNvdmVyeSUyMGJlZHJvb20lMjBwZWFjZWZ1bCUyMG5pZ2h0fGVufDF8fHx8MTc1ODE3ODU4MHww&ixlib=rb-4.1.0&q=80&w=1080')` }} />
    </div>
  );
}
      ...
      <div className="flex flex-col items-center overflow-clip relative size-full">
        <div className="box-border content-stretch flex flex-col gap-[16px] items-center justify-start p-[16px] relative size-full">
          ...
          <div className="font-['Roboto:Regular',_sans-serif] font-normal leading-[0] min-w-full relative shrink-0 text-[#101828] text-[14px] text-center tracking-[0.25px]" style={{ width: "min-content", fontVariationSettings: "'wdth' 100" }}>
            <p className="leading-[1.5]">Quality sleep allows your body to repair and reset metabolic processes for optimal function</p>
          </div>
        </div>
      </div>
...
function InfoIcon1() {
  return (
    <div className="bg-[#fef1c7] overflow-clip relative rounded-[100px] shrink-0 size-[60px]" data-name="info icon">
      <div className="absolute bg-center bg-cover bg-no-repeat left-0 size-[60px] top-0" data-name="hormone icon" style={{ backgroundImage: `url('https://images.unsplash.com/photo-1745562294709-d895f1d04254?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxzbGVlcCUyMHJlc3QlMjByZWNvdmVyeSUyMGJlZHJvb20lMjBwZWFjZWZ1bCUyMG5pZ2h0fGVufDF8fHx8MTc1ODE3ODU4MHww&ixlib=rb-4.1.0&q=80&w=1080')` }} />
    </div>
  );
}
    ...
    <div className="basis-0 bg-[#fffbee] grow h-full min-h-px min-w-px relative rounded-[16px] shrink-0" data-name="info card">
      <div className="flex flex-col items-center overflow-clip relative size-full">
        <div className="box-border content-stretch flex flex-col gap-[16px] items-center justify-start p-[16px] relative size-full">
          <InfoIcon1 />
          <div className="font-['Roboto:Regular',_sans-serif] font-normal leading-[0] min-w-full relative shrink-0 text-[#101828] text-[14px] text-center tracking-[0.25px]" style={{ width: "min-content", fontVariationSettings: "'wdth' 100" }}>
            <p className="leading-[1.5]">Proper sleep helps regulate hunger hormones like leptin and ghrelin, controlling appetite naturally</p>
          </div>
        </div>
      </div>
      <div aria-hidden="true" className="absolute border border-[#e7c144] border-solid inset-0 pointer-events-none rounded-[16px]" />
...
export default function BenefitsCalloutDay4() {
  return (
