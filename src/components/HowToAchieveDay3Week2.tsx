...
interface HowToAchieveDay3Week2Props {
  onItemComplete?: (itemId: string) => void;
}

export function HowToAchieveDay3Week2({ onItemComplete }: HowToAchieveDay3Week2Props) {
  const actionItems = [
    {
      id: "how-to-start",
      title: "How to start jogging",
      description: "",
      subItems: [
        {
          category: "",
          items: "Treat jogging like a quicker walk. Begin slowly, let your body find its rhythm, then ease into a steady pace. Even 15 to 20 minutes is enough to unlock the benefits"
        }
      ]
    },
    {
      id: "choosing-time",
      title: "Choosing the right time that works for you",
      description: "",
      subItems: [
        {
          category: "",
          items: "Mornings are great for a fresh start and clear mind, but evenings work just as well if that's when you have space in your day. The best time is the one you can stick to."
        }
      ]
    },
    {
      id: "short-walks",
      title: "Why your short walks still matter",
      description: "",
      subItems: [
        {
          category: "",
          items: "Keep your 10 minute walks after meals. They help your digestion and circulation, while jogging gives you the extra push for fat burn and stamina."
        }
      ]
    }
  ];
