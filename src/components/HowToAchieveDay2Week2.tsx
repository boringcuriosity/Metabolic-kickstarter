...
interface HowToAchieveDay2Week2Props {
  onItemComplete?: (itemId: string) => void;
}

export function HowToAchieveDay2Week2({ onItemComplete }: HowToAchieveDay2Week2Props) {
  const actionItems = [
    {
      id: "before-sleeping",
      ...
      subItems: [
        {
          category: "",
          items: "Place a filled bottle of water beside your bed so it's the first thing you reach for in the morning"
        }
      ]
    },
    {
      id: "stay-covered",
      title: "Stay covered while out",
      description: "",
      subItems: [
        {
          category: "",
          items: "Always carry a bottle when you step out. If you commute, keep one in your bag and another in the car"
        }
      ]
    },
    {
      id: "keep-habit",
      title: "Keep the habit alive",
      description: "",
      subItems: [
        {
          category: "",
          items: "Along with your morning ritual, continue last week's practice of 2 litres/day"
        }
      ]
    }
  ];
