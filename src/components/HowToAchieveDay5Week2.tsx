...
interface HowToAchieveDay5Week2Props {
  onItemComplete?: (itemId: string) => void;
}

export function HowToAchieveDay5Week2({ onItemComplete }: HowToAchieveDay5Week2Props) {
  const actionItems = [
    {
      id: "quiet-spot",
      title: "Find your quiet spot",
      description: "",
      subItems: [
        {
          category: "",
          items: "Sit comfortably on a chair, bed, or floor. Close your eyes and let your body relax"
        }
      ]
    },
    {
      ...
      subItems: [
        {
          category: "",
          items: "Play a 10-minute guided meditation, focus on slow breathing, or try a short body scan"
        }
      ]
    },
    {
      ...
      subItems: [
        {
          category: "",
          items: "One session a day is enough. Over time, your brain learns to switch into calm more easily."
        }
      ]
    }
  ];
